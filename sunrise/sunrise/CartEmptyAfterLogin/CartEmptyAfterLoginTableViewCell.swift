//
//  CartEmptyAfterLoginTableViewCell.swift
//  sunrise
//
...
protocol CartEmptyAfterLoginTableViewCellDelegate {
    
    func productSelectedWithProductInfo(productInfo : [String : AnyObject])
}


class CartEmptyAfterLoginTableViewCell: UITableViewCell {
    ...
    var delegate : CartEmptyAfterLoginTableViewCellDelegate?
